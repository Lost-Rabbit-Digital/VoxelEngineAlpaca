...
class VoxelHandler:
    def __init__(self, world):
        ...
        # 0: Remove the selected voxel
        # 1: Create a new voxel
    ...
    def ray_cast(self):
        # Starting point of the ray cast
        x1, y1, z1 = self.app.player.position
        # Ending point of the ray cast
        ...
        while not (max_x > 1.0 and max_y > 1.0 and max_z > 1.0):
            ...
            if result[0]:
                ...
                # Calculate the normal of the voxel for the ability to correctly create voxels
                if step_dir == 0:
